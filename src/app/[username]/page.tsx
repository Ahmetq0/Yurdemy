  ...
  return (
    <div className="">
      ...
      <div className="flex items-center gap-8 sticky top-0 backdrop-blur-md p-4 z-10 bg-[#00000084]">
        ...
        <h1 className="font-bold text-lg">Ahmethan</h1>
      </div>
      {/* INFO */}
      <div className="">
        ...
        <div className="p-4 flex flex-col gap-2">
          {/* USERNAME & HANDLE */}
          <div className="">
            <h1 className="text-2xl font-bold">Ahmethan İhtiyar</h1>
            <span className="text-textGray text-sm">@ahmethanihtiyar729</span>
          </div>
          {/* JOB & LOCATION & DATE */}
          ...
          <div className="flex gap-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-textGray text-[15px]">Takipçi</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="font-bold">100</span>
              <span className="text-textGray text-[15px]">Takip</span>
            </div>
          </div>
        </div>
      </div>
